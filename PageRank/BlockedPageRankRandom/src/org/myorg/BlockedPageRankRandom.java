...
public class BlockedPageRankRandom {    
	private static NumberFormat nf = new DecimalFormat("00");
	public static final int N = 685230;
	
    public static void main(String[] args) throws Exception {
    	BlockedPageRankRandom rank = new BlockedPageRankRandom();
        ...
        for (int i = 1; i < residualAndHighestRank.size(); ++ i) {
        	System.out.println("Highest Rank Value in Block " + (i-1) + " is " + residualAndHighestRank.get(i) / N);
        }
    }
    
    public ArrayList<Double> runPageRankCalculation(String InputPath, String OutputPath) throws Exception {    	
    	JobConf conf = new JobConf(BlockedPageRankRandom.class);
        conf.setJarByClass(BlockedPageRankRandom.class);
        ...
        double averageResidual = residualSum / BlockedPageRankRandom.N;
        ...
        for (int i = 0; i < block_num; ++ i) {
        	...
        	double highestValue = c.getValue() / (1.0 * 10e6);
